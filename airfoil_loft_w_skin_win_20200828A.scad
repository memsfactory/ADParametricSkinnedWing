...
//Thank you to all the Openscad library coders who made this possible.
...
// airfoil coordinates can be downloaded in the format compatible with 
// Openscad here -> http://chaaawa.com/airfoils/index.cgi?o=name&n=200&p=0

//sample airfoils used in the code to play around and test note chord length is normalized to 1000
...
//Just testing to check how many points are in each airfoil
...
// scaling airfoils to the correct chord length
...
// This offset command is key because it accurately creates an smaller airfoil polygon (of points)
